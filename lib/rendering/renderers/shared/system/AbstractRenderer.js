...
const _AbstractRenderer = class _AbstractRenderer extends EventEmitter {
  ...
  async init(options = {}) {
    ...
    options = __spreadValues(__spreadValues({}, _AbstractRenderer.defaultOptions), options);
  ...
  clear(options = {}) {
    ...
    (_a = options.clear) != null ? _a : options.clear = _const.CLEAR.ALL;
    const { clear, clearColor, target } = options;
    Color.Color.shared.setValue(clearColor != null ? clearColor : this.background.colorRgba);
