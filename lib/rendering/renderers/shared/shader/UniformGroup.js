...
const _UniformGroup = class _UniformGroup {
  ...
  constructor(uniformStructures, options) {
    ...
    var _a, _b;
    options = __spreadValues(__spreadValues({}, _UniformGroup.defaultOptions), options);
    ...
    for (const i in uniformStructures) {
      ...
      (_b = uniformData.value) != null ? _b : uniformData.value = getDefaultUniformValue.getDefaultUniformValue(uniformData.type, uniformData.size);
