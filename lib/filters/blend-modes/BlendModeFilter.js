...
class BlendModeFilter extends Filter.Filter {
  constructor(options) {
    ...
    const gpuSource = compileBlendModeShader(__spreadValues({ source: blendTemplate.default }, gpuOptions));
    ...
    const glSource = compileBlendModeShader(__spreadValues({ source: blendTemplate$1.default }, glOptions));
