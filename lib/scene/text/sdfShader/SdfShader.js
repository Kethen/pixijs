...
var maxRecommendedTextures = require('../../../rendering/renderers/shared/texture/utils/maxRecommendedTextures.js');
...
class SdfShader extends Shader.Shader {
  constructor() {
    ...
    gpuProgram != null ? gpuProgram : gpuProgram = compileHighShaderToProgram.compileHighShaderGpuProgram({
      name: "sdf-shader",
      bits: [
        colorBit.colorBit,
    ...
    glProgram != null ? glProgram : glProgram = compileHighShaderToProgram.compileHighShaderGlProgram({
      name: "sdf-shader",
      bits: [
        colorBit.colorBitGl,
