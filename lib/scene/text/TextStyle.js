...
const _TextStyle = class _TextStyle extends EventEmitter {
  constructor(style = {}) {
    ...
    const fullStyle = __spreadValues(__spreadValues({}, _TextStyle.defaultTextStyle), style);
  ...
  set dropShadow(value) {
    if (value !== null && typeof value === "object") {
      this._dropShadow = this._createProxy(__spreadValues(__spreadValues({}, _TextStyle.defaultDropShadow), value));
    } else {
      this._dropShadow = value ? this._createProxy(__spreadValues({}, _TextStyle.defaultDropShadow)) : null;
    }
    this.update();
  }
  ...
  set fill(value) {
    ...
    if (this._isFillStyle(value)) {
      this._originalFill = this._createProxy(__spreadValues(__spreadValues({}, GraphicsContext.GraphicsContext.defaultFillStyle), value), () => {
  ...
  set stroke(value) {
    ...
    if (this._isFillStyle(value)) {
      this._originalStroke = this._createProxy(__spreadValues(__spreadValues({}, GraphicsContext.GraphicsContext.defaultStrokeStyle), value), () => {
  ...
  _isFillStyle(value) {
    return (value != null ? value : null) !== null && !(Color.Color.isColorLike(value) || value instanceof FillGradient.FillGradient || value instanceof FillPattern.FillPattern);
  }
};
